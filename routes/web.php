...
// Manager routes (Admin and Manager access)
Route::middleware(['authorize.manager'])->group(function () {
...
// Staff routes (All authenticated users - Admin, Manager, Staff)
Route::middleware(['authorize.staff'])->group(function () {
    // Akses read-only untuk barang
    Route::group(['prefix' => 'barang'], function () {
